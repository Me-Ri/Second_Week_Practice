...
<body>
    ...
    <main>
        <form action="../back/crud/groupUp.php" method="post" enctype="multipart/form-data">
        <div class="main-container">
            <div class="main-content">
                <div class="practic">
                    <div>
                        <h2>Номер группы</h2>
                        <input type="text" value="<?php echo $group['name']?>" name="group-name" placeholder="Введите номер группы">
                    </div>
                    <div>
                        <h2>Курс</h2>
                        
                        <input type="text" value="<?php echo $group['course']?>" name="group-course" placeholder="Введите курс">
                    </div>      
                    <input type="hidden" name="id_dir" value="<?php echo $idDir ?>">  
                    <input type="hidden" name="id_group" value="<?php echo $idGroup ?>">  
                </div>
            </div>

...
$practice = mysqli_fetch_assoc(mysqli_query($connect, "SELECT * FROM `practice` WHERE id = '$id_prac'"));
...
<body>
    ...
    <main>
        <div class="main-container">
            <form action="../back/crud/PracticeUp.php" method="post" enctype="multipart/form-data">
                <div class="main-content">
                    <div class="practic">
                        <div>
                            <h2>Год</h2>
                            <input type="number" name="year" value="<?php echo $practice['year'] ?>" placeholder="Введите год прохождения практики">
                        </div>
                        <div>
                            <h2>Вид практики</h2>
                            <select name="view">
                        ...
                        <div>
                            <h2>Тип практики</h2>
                            <select name="type">
                                <option value="Ознакомительная" <?php if($practice['type'] == 'Ознакомительная' ) { echo 'selected'; } ?>>Ознакомительная</option>
                            </select>
                        </div>             
                    </div>
                    <div class="practic">
                        ...
                        <div>
                            ...
                            <input type="text" value="<?php echo $practice['address'] ?>" name="place" placeholder="Введите адрес практики">
                        </div>    
                    </div>
                    <div class="practic">
                        <div>
                    ...
                    <div class="practic">
                        <div>
                            <h2>Номер приказа</h2>
                            <input type="text"  name="order_num" value="<?php echo $practice['order_num'] ?>" placeholder="Введите номер приказа">
                        </div>
                        <div>
                            <h2>Дата приказа</h2>
                            <input type="text" name="order_date" value="<?php echo $practice['order_date'] ?>" placeholder="Введите дату приказа">
                        </div>    
                    </div>
                    <div class="practic">
                        <div>
                            <h2>Дата начала</h2>
                            <input type="text" name="start_date" value="<?php echo $practice['start_date'] ?>" placeholder="Введите дату начала практики">
                        </div>
                        <div>
                            <h2>Дата конца</h2>
                            <input type="text" name="end_date" value="<?php echo $practice['end_date'] ?>" placeholder="Введите дату конца практики">
                        </div>    
                    </div>
                </div>
